...
class TracedEnv:
    ...
    def extract_game_state(self, objects, info):
        ...
        OCAtari Seaquest categories: Player, Diver, Shark, Submarine,
        EnemyMissile, PlayerMissile, CollectedDiver, PlayerScore.

        Returns a dict with:
          - "Player": submarine state {x, y, w, h, dx, dy}
          - "Enemies": list of enemy states [{x, y, w, h, dx, dy, type}, ...]
            (Shark, Submarine, EnemyMissile)
          - "Divers": list of diver states [{x, y, w, h, dx, dy}, ...]
            (divers to rescue)
        ...
        for obj in objects:
            if obj is None:
                continue
            cat = obj.category
            if cat in ("NoObject", "PlayerMissile", "CollectedDiver",
                       "PlayerScore"):
                continue
            elif cat == "Player":
                obs["Player"] = {
            ...
            elif cat in ("Shark", "Submarine", "EnemyMissile"):
                enemies.append({
                    "x": obj.x, "y": obj.y,
                    "w": obj.w, "h": obj.h,
                    "dx": obj.dx, "dy": obj.dy,
    ...
    def reset(self, seed=None, options=None):
        ...
        Seaquest has no FIRE-to-start requirement.
        """
