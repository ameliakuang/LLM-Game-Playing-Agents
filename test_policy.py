...
def policy(obs):
    '''
    A policy that moves the paddle horizontally towards the ball.
    ...
    Args:
        obs (dict): A dictionary with keys "ball_pos" and "paddle_pos" 
                    representing the positions of the ball and paddle.
    Output:
